        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              child:Text(
                "Ernakulam",style: TextStyle(fontSize:30,
              fontWeight: FontWeight.bold),
              ),),
              SizedBox(
                height: 10,
              ...
              Container(
                ...
                child:Text(
                  "Area : 2189 sqkm",style: TextStyle(fontSize:20,
                    ),
                ),),
              SizedBox(
                height: 10,
              ...
              Container(
                ...
                child:Text(
                  "Discription:",style: TextStyle(fontSize:20,
                  fontWeight: FontWeight.bold
                ),
                ),),
              SizedBox(
